 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="RfidBundle\Entity\ProductRepository")
 */
class Product
{
    ...
    /**
     * Set uniqueRetailerId
     *
     * @param string $uniqueRetailerId
     *
     * @return Product
     */
    public function setUniqueRetailerId($uniqueRetailerId)
    {
